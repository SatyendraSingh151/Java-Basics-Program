...
// Right and Left Right Angle Triangle mirror Together
public class Right_Left_Right_Angle_Triangle_Mirror_Together {
...
//		taking the user input by making the object of the Scanner class
		...
		System.out.print("Give the value to print the right and left angle triangle mirror together : ");
		int n = sc.nextInt();
